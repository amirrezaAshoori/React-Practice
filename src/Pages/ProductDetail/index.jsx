...
export default function ProductDetail() {
  ...
  return (
    <>
      {product ? <div className="card py-5 mb-3 w-75 shadow-lg detail-card">
        <div className="row g-0">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text">Price : ${product.attributes.price / 100}</p>
              ...
              <div className='d-flex align-items-center'>
                ...
                {quantity && <>
                  ...
                  <button className='btn btn-danger' onClick={() => dispatch(removeItem(id))}>-</button>
                </>}
              </div>
            </div>
          </div>
